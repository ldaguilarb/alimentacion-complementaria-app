...
export function RegistroComidas() {
  const { alimentos, loading: loadingAlimentos, refetch: refetchAlimentos } = useAlimentos()
  ...
  async function onAlimentoGuardado() {
